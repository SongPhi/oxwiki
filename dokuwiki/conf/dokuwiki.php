...
/* Basic Settings */
$conf['title']       = 'DOCUMENTATION';        //what to show in the title
$conf['start']       = 'start';           //name of start page
$conf['lang']        = 'en';              //your language
$conf['template']    = 'oxwiki';         //see lib/tpl directory
$conf['tagline']     = '';                //tagline in header (if template supports it)
$conf['sidebar']     = 'sidebar';         //name of sidebar in root namespace (if template supports it)
$conf['license']     = 'cc-by-nc-sa';     //see conf/license.php
$conf['savedir']     = OXWIKI_DIR_PLUGINFILES.'data';          //where to store all the files
$conf['basedir']     = '';                //absolute dir from serveroot - blank for autodetection
$conf['baseurl']     = OXWIKI_URL_BASE;                //URL to server including protocol - blank for autodetect
...
$conf['readdircache'] = 300;               //time cache in second for the readdir operation, 0 to deactivate.
